...
def visualize_dataset(args):
    ...
    im_dir = os.path.join(os.path.dirname(args.config),
                          config_dict['path'], config_dict[args.dataset_mode])
    label_dir = os.path.join(os.path.dirname(
        args.config), config_dict['path'], args.labels)
    ...
    for im_file in os.listdir(im_dir):
        ...
        for ann in annotations:
            ...
            x1, y1, x2, y2 = xywh[0]-xywh[2]//2, xywh[1] - \
                xywh[3]//2, xywh[0]+xywh[2]//2, xywh[1]+xywh[3]//2
